  ...
  return (
    <>
      ...
      <div className="relative min-h-[70vh] flex flex-col items-center justify-center pt-10 pb-20">
        ...
        >
          <span className="font-sans text-sm font-800 uppercase tracking-widest text-white">Creative Writer</span>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, scale: 0 }}
          animate={{ opacity: 1, scale: 1 }}
        ...
        >
          <span className="font-display text-4xl text-white">5Y</span>
        </motion.div>
        ...
        >
          <motion.h1 variants={fadeUp} className="font-display text-[96px] sm:text-[120px] font-bold leading-[0.9] tracking-[-0.02em] text-[#1A1020] drop-shadow-[4px_4px_0_rgba(255,61,138,1)]">
            STORIES THAT <br /> BUILD <span className="text-[#FFD93D] italic drop-shadow-[4px_4px_0_rgba(26,16,32,1)]">IMPACT.</span>
          </motion.h1>
          <motion.p variants={fadeUp} className="font-sans text-xl font-600 leading-relaxed text-[#3D2F50] max-w-[680px] bg-[#FFFBEE]/80 backdrop-blur-sm p-4 rounded-xl">
            Creative writer with 5 years of experience turning ideas into scripts, content plans, and social stories people remember.
          </motion.p>
          <motion.div variants={fadeUp} className="flex flex-wrap items-center justify-center gap-4 mt-4">
            <PortfolioDarkCtaLink to="/projects">Explore projects</PortfolioDarkCtaLink>
          </motion.div>
        </motion.div>
      </div>
        ...
        <div className="flex whitespace-nowrap animate-[marquee_15s_linear_infinite]">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="flex items-center gap-8 px-4">
              <span className="font-display text-3xl font-bold text-[#FFD93D] uppercase">Scripts</span>
              <span className="text-2xl text-white">✦</span>
              <span className="font-display text-3xl font-bold text-[#FF6B6B] uppercase">YouTube</span>
              <span className="text-2xl text-white">✦</span>
              <span className="font-display text-3xl font-bold text-[#A855F7] uppercase">Reels</span>
              <span className="text-2xl text-white">✦</span>
      ...
      <div className="relative py-32 flex flex-col items-center overflow-hidden px-4 sm:px-0">
        ...
        >
          The <span className="text-[#FF3D8A] underline decoration-8 underline-offset-8">Writing Stack</span>
        </motion.h2>
        ...
        >
          ...
          >
            ...
            <h3 className="font-display text-3xl font-bold text-[#1A1020] mb-2">Story Development</h3>
            <p className="font-sans text-lg font-600 text-[#5A4A6A]">From rough idea to full script for social videos, podcasts, and branded content.</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="font-display text-3xl font-bold text-[#1A1020] mb-2">Platform Adaptation</h3>
            <p className="font-sans text-lg font-600 text-[#5A4A6A]">Adjusting one core message for YouTube, Reels, and platform-specific audience behavior.</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="font-display text-3xl font-bold text-[#1A1020] mb-2">Editorial Execution</h3>
            <p className="font-sans text-lg font-600 text-[#5A4A6A]">Writing website articles and campaign copy with a clear voice, structure, and tone.</p>
          </motion.div>
      ...
      <div className="py-20">
        ...
        >
          ...
          <p className="max-w-full rounded-2xl border-2 border-[#1A1020] bg-white px-5 py-4 font-sans text-lg font-600 leading-relaxed text-[#1A1020] shadow-[4px_4px_0_0_#1A1020] md:max-w-[min(100%,400px)] md:text-right">
            A quick preview of selected projects. Full case highlights and horizontal walkthrough are available on the Projects page.
          </p>
        </motion.div>
              ...
              <div className="flex-1 flex flex-col justify-between gap-8">
                <div>
                  <div className="inline-block rounded-full bg-[#FF3D8A] border-2 border-[#1A1020] px-4 py-1.5 mb-6 rotate-[-2deg]">
                    <span className="font-sans text-sm font-800 uppercase tracking-widest text-white">Double D</span>
                  </div>
                  <h3 className="font-display text-[32px] md:text-[44px] font-bold leading-tight text-white mb-4">
                    Creative for The Sinathrya, Darius, and Donna channels.
                  </h3>
                  <p className="font-sans text-lg md:text-xl font-500 text-[#C0A8E0]">
                    Developing ideas, scripting daily content, and supporting production for YouTube and social media campaigns.
                  </p>
                </div>
              ...
              <div className="flex-1 flex flex-col justify-between gap-8">
                <div>
                  <div className="inline-block rounded-full bg-[#FFD93D] border-2 border-[#1A1020] px-4 py-1.5 mb-6 rotate-[2deg]">
                    <span className="font-sans text-sm font-800 uppercase tracking-widest text-[#1A1020]">VDVC</span>
                  </div>
                  <h3 className="font-display text-[32px] md:text-[44px] font-bold leading-tight text-[#1A1020] mb-4">
                    Creative Writer and Host for Muslimpedia programs.
                  </h3>
                  <p className="font-sans text-lg md:text-xl font-500 text-[#5A4A6A]">
                    Creating script concepts for Muslimpedia, Kata Ustadz, Muslim Update, and related show formats.
                  </p>
                </div>
                <PortfolioDarkCtaLink to="/projects">Open Projects →</PortfolioDarkCtaLink>
              </div>
              <div className="w-full md:w-[40%] aspect-square rounded-[20px] bg-[#FFF0F7] border-2 border-[#1A1020] overflow-hidden">
                <img src="/projects/vdvc.png" alt="VDVC project preview" className="h-full w-full object-cover" loading="lazy" />
              </div>
            </div>
          </motion.div>
        </div>
      ...
      >
        ...
        <p className="relative z-10 font-sans text-2xl font-600 text-[#F5EDFF] mb-10 max-w-[680px]">
          Need support for scripting, social content planning, or campaign storytelling?
        </p>
